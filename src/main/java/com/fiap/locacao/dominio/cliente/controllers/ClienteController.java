package com.fiap.locacao.dominio.cliente.controllers;



import com.fiap.locacao.dominio.cliente.dto.ClienteDTO;
import com.fiap.locacao.dominio.cliente.dto.ClientePatchDTO;
import com.fiap.locacao.dominio.cliente.sevices.ClienteService;
...
public class ClienteController {
    ...
    @Operation(tags="Lista de clientes" ,summary = "Lista todos os clientes cadastrados no banco de dados",method = "GET")
    @ApiResponses(value = {
